...
BASE_MODEL_DOWNLOAD_URLS = [
    "https://github.com/HellerCommaA/ComfyUI-Frame-Interpolation/releases/download/download/",
    "https://github.com/saibaraburabo-blip/ComfyUI-Frame-Interpolation/releases/download/models/",
